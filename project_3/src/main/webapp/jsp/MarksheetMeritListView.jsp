...
.p4 {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/userctlf.jpg');
...
<b>
				<table class="table table-responsive">
					<table class="table table-dark" style="background-image: url('<%=ORSView.APP_CONTEXT%>/img/avatar-g92feff2a2_1920.webp');">
						<thead>
